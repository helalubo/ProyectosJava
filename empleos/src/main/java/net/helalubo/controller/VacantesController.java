...
public class VacantesController {
	...
	@Autowired
	// @Qualifier("categoriasServiceJpa") //con esto marcamos que la clase que sera
	// implementada por la interface ICategoriaService sera categoriasServiceJpa
	...
	/// Gracias a que los atributos name de los input del formulario coinciden con
	/// los nombres de los campos de la clase vacante
	...
	// Esto gracias a su metodo hasErros que nos permite verificar si tiene errores
	// y en el caso de que haya algun error en
	// spring podremos redirigirlo a otra vista

	/// agrego el parametro RedirectAttributes para que pueda agregar un dato a la
	/// redireccion del template que se necesita en el caso del
	...
	public String Guardar(Vacante vacante, BindingResult result, RedirectAttributes attributes,
		...
		// En caso de que el objeto result detecte algun tipo de error con hasErrors y
		// nos retornara denuevo al formulario.

		/// para ver los errores de consola podemos iterar los object errors de la lista
		/// de errores que esta dentro del objeto result de BindingResult
		...
		// Si quiero puedo agregar al RedirectAttributes un mensaje el cual se podra
		// utilizar en el template donde se a redirigido la app
		// tambien por le hecho de ser un metodo post. el RedirectAttributes se usa
		// cuando queremos mandar
		// alguna informacion a un template al cual se ha sido redirigido, esto usando
		// addFlashAttribute
	...
	/*
	 * Uso variable dinamica para poder acceder a cada uno de los empleos, esto es
	 * por id. Busca la vacante que sea igual al id y devuelve el objeto agregandolo
	 * al model para luego ser usada en la vista devuelta como string en la
	 * funccion.
	 * 
	 * @see detalle.html
	 * 
	...
	// Metodo que pareca implicitamente en el momento de que spring trabaja con los
	// formularios input,
	// en este caso toma una fecha en string y la transforma en el dato deseado,
	// sirve para varios tipos de datos.
	...
	// Paginacion con busqueda usando listVacantes.html
	// como vista
